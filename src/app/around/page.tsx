...
const copy = {
  ...
  eyebrow: "Your party photos, together",
  ...
  footerTag: "Live the moments. Share the perspectives.", privacy: "Privacy", terms: "Terms of use", operator: "A project by thehnh.tech", availability: "Made for iPhone"
} as const;
...
export function generateMetadata(): Metadata {
  ...
  const url = `${SITE}/`;
  return {
    // Absolute URLs keep this product site independent of the store metadata.
    metadataBase: null,
    ...
    keywords: ["Picture me around", "party photos", "photo circle", "around", "Radar"],
    alternates: { canonical: url, languages: {}, types: {} },
    openGraph: { type: "website", siteName: "Picture me around", title: t.title, description: t.description, url, locale: "en_GB", images: [{ url: `${SITE}/around/icon.png`, width: 1024, height: 1024, alt: "Picture me around — Radar" }] },
...
export default function AroundPage() {
  ...
  return <main className={styles.page} lang="en" id="top">
    <JsonLd id="ld-around-website" data={{ "@context": "https://schema.org", "@type": "WebSite", "@id": `${SITE}/#website`, name: "Picture me around", url: SITE, description: t.description, inLanguage: "en", publisher: { "@type": "Organization", name: "thehnh.tech", url: "https://thehnh.tech" } }} />
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}><span>{t.availability}</span><nav aria-label="Legal information"><a href={PRIVACY}>{t.privacy}</a><a href={TERMS}>{t.terms}</a><a href={SUPPORT}>{t.navContact}</a></nav><a href="https://thehnh.tech">{t.operator}<ArrowUpRight size={12} /></a></div>
      </footer>
    </div>
  </main>;
}
